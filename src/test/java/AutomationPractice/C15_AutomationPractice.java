...
public class C15_AutomationPractice {
    ...
    public void test() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@type='text']")).sendKeys("Mehmet Fatih" , Keys.TAB , "fatih57.aba.aba.aba.aba.aba.@gmail.com" , Keys.ENTER);
        ...
        driver.findElement(By.xpath("//input[@type='text']")).sendKeys("Fatih", Keys.TAB,"fatih57@gmail.com",Keys.ENTER);
        ...
        driver.findElement(By.cssSelector("#first_name")).sendKeys("Fatih",Keys.TAB," YILDIRIM",Keys.TAB,"Techproeducation");
