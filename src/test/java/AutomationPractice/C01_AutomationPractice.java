...
public class C01_AutomationPractice {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.cssSelector("input[type='text']")).sendKeys("Mehmet Fatih", Keys.TAB,"mehmet.fatihh57@gmail.com");
       ...
       driver.findElement(By.cssSelector("#first_name")).sendKeys("Mehmet Fatih", Keys.TAB,"YILDIRIM",Keys.TAB,"techpro",Keys.TAB,"Sinop",Keys.TAB,"İstanbul");
       driver.findElement(By.cssSelector("#country")).sendKeys("Turkey",Keys.TAB,"N",Keys.TAB,"Istanbul",Keys.TAB,"Maltepe",Keys.TAB,"41000",Keys.TAB,"5452375039");
