...
public class C03_Trendyol {
    public static void main(String[] args) throws InterruptedException {
       ...
       */
        ...
        //Cok satanlar kategorisine tikla
        WebElement cokSatanlar = driver.findElement(By.xpath("(//a[@class='category-header navbar-first-cap'])[10]"));
        cokSatanlar.click();
        Thread.sleep(2000);

        //Giyim bolumunun yanindaki ayakkabi bolumune tikla
        WebElement giyim = driver.findElement(By.xpath("(//div[@class='navigation-section-tabs-container-item'])[1]"));
        Thread.sleep(2000);
        WebElement ayakkabi2 = driver.findElement(with(By.tagName("div")).toRightOf(giyim));
        Thread.sleep(2000);
        ayakkabi2.click();
        Thread.sleep(3000);
